...
class ValidateCodeViewController: InitialBaseViewController {
    ...
    @IBAction func resetPasswordBtnTapped(_ sender: Any) {
        ...
        APIManager.shared.validate(email: email, reset_code: reset_code.toNumber()!, onFailure: { title, body in
